...
<html>
    ...
    <body onload="myFunction()">
     <div id="loading"></div>
	   <div style="background-image:linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)), url('images/product6.jpeg');background-repeat: no-repeat;background-size: 100% 100%;width: 100%;height: 660px;">
	 ...
	 <section class="">
		  <div class="row">
			  ...
			  <div class="card flex-md-row mb-4 shadow-sm h-md-250 mb-auto">
				  <img class="card-img img-fluid" alt="Thumbnail [500x250]" src="images/image4.jpg" style="width: 500px; height: 250px;">
				  <div class="card-body d-flex flex-column align-items-start">
					  <h4><strong class="d-inline-block mb-3 text-primary">Gastech</strong></h4>
					  <h6 class="mb-auto">
						  An IOT Product To Take The Safety Of Day To Day Life In A Next Level
					  </h6>
					  <!--<h6 class="mb-0">-->
			  ...
			  <div class="col-md-12 col-sm-12">
			  <div class="card flex-md-row mb-4 shadow-sm h-md-250 mb-auto">
				  <img class="card-img img-fluid" alt="Thumbnail [500x250]" src="images/product1.jpeg" style="width: 500px; height: 250px;">
				  <div class="card-body d-flex flex-column align-items-start">
					  <h4><strong class="d-inline-block mb-3 text-primary">Autism Care</strong></h4>
					  <h6 class="mb-auto">
						  A Website To Create A Better World For ASD Sufferers
					  </h6>
					  <!--<h6 class="mb-0">-->
						  <!--<a class="text-dark" href="#">40 Percent of People Can’t Afford Basics</a>-->
					  <!--</h6>-->
			  ...
			  <div class="col-md-12 col-sm-12">
			  <div class="card flex-md-row mb-4 shadow-sm h-md-250 mb-auto">
				  <img class="card-img img-fluid" alt="Thumbnail [500x250]" src="images/product2.jpeg" style="width: 500px; height: 250px;">
				  <div class="card-body d-flex flex-column align-items-start">
					  <h4><strong class="d-inline-block mb-3 text-primary">Shikhe Nao</strong></h4>
					  <h6 class="mb-auto">
						  New Generation Educational Website
					  </h6>
					  <!--<h6 class="mb-0">-->
						  <!--<a class="text-dark" href="#">40 Percent of People Can’t Afford Basics</a>-->
					  <!--</h6>-->
			   ...
			   <div class="col-md-12 col-sm-12">
			  <div class="card flex-md-row mb-4 shadow-sm h-md-250 mb-auto">
				  <img class="card-img img-fluid" alt="Thumbnail [500x250]" src="images/health.jpg" style="width: 500px; height: 250px;">
				  <div class="card-body d-flex flex-column align-items-start">
					  <h4><strong class="d-inline-block mb-3 text-primary">One Minute Health</strong></h4>
					  <h6 class="mb-auto">
						  Taking Medicines On Time Now Got Easier
					  </h6>
					  <!--<h6 class="mb-0">-->
						  <!--<a class="text-dark" href="#">40 Percent of People Can’t Afford Basics</a>-->
					  <!--</h6>-->
